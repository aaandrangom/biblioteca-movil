...
public static b4a.example.httputils2service _httputils2service = null;
  public Object[] GetGlobals() {
		return new Object[] {"DateUtils",starter.mostCurrent._dateutils,"HttpUtils2Service",Debug.moduleToString(b4a.example.httputils2service.class),"Main",Debug.moduleToString(b4a.example.main.class),"Principal",Debug.moduleToString(b4a.example.principal.class),"RegistroUsuario",Debug.moduleToString(b4a.example.registrousuario.class),"Service",starter.mostCurrent._service,"ValidacionUsuario",Debug.moduleToString(b4a.example.validacionusuario.class)};
}
}